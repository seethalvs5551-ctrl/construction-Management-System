...
?>
            ...
            <div class="row text-center justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="servicecard-single">
                        ...
                        <div class="content-main-top">
                            <h4><a href="services.php">Renovation</a></h4>
                            <p>Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua labore et dolore magna.
                            </p>
                            <a class="btn btn-style mt-4" href="services.php">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="servicecard-single">
                        ...
                        <div class="content-main-top">
                            <h4><a href="services.php">Mechanical Works</a></h4>
                            <p>Get Vastu compliant Design at Just Re.1/Sq.Ft
                            </p>
                            <a class="btn btn-style mt-4" href="services.php">Read More</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="servicecard-single">
                        ...
                        <div class="content-main-top">
                            <h4><a href="services.php">Construction Materials</a></h4>
                            <p>Get all construction and furnishing materials at wholesales rates.
                            </p>
                            <a class="btn btn-style mt-4" href="services.php">Read More</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    <div class="servicecard-single">
                        ...
                        <div class="content-main-top">
                            <h4><a href="services.php">Labour Contractor</a></h4>
                            <p>Hire the trained workers and build a stong and long lasting structure.
                            </p>
                            <a class="btn btn-style mt-4" href="services.php">Read More</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    <div class="servicecard-single">
                        ...
                        <div class="content-main-top">
                            <h4><a href="services.php">Architechural Design</a></h4>
                            <p>Get Vastu Complaint Design at just Re.1/Sq.Ft.</p>
                            <a class="btn btn-style mt-4" href="services.php">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-4">
                    <div class="servicecard-single">
                        ...
                        <div class="content-main-top">
                            <h4><a href="services.php">Engineering Consultation Services</a></h4>
                            <p>Expert engineering consultation for your construction projects.
                            </p>
                            <a class="btn btn-style mt-4" href="services.php">Read More</a>
                        </div>
                    </div>
    ...
    <section class="w3l-pricing py-5">
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
                <h5 class="sub-title">Construction Materials</h5>
                <h3 class="title-style">More Details on Pricing</h3>
            </div>
            <div class="row t-in justify-content-center">
                <div class="col-lg-4 col-md-6 price-main-info">
                    <div class="price-inner card">
                        <div class="card-body">
                            <h4 class="text-center mb-3">Dry Cleaning</h4>
                            <h5 class="card-title pricing-card-title">
                                <span class="align-top">$</span>19
                            </h5>
                            <ul class="list-unstyled mt-3 mb-4">
                                <li> <span class="fa fa-check"></span> All Shirts </li>
                                <li> <span class="fa fa-check"></span> Pants, Jeans, Skirts </li>
                                <li class="disable"> <span class="fa fa-check"></span> Sweaters</li>
                                <li class="disable"> <span class="fa fa-check"></span> Tie, Scarf </li>
                                <li class="disable"> <span class="fa fa-check"></span> Coat, Jacket, Dress </li>
                            </ul>
                            <div class="read-more mt-4 pt-lg-2 text-center">
                                <a href="contact.php" class="btn btn-style"> Order Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 price-main-info mt-md-0 mt-4">
                    <div class="price-inner card">
                        <div class="card-body">
                            <h4 class="text-center mb-3">Steam Ironing</h4>
                            <h5 class="card-title pricing-card-title">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <li> <span class="fa fa-check"></span> All Shirts </li>
                                <li> <span class="fa fa-check"></span> Pants, Jeans, Skirts </li>
                                <li> <span class="fa fa-check"></span> Sweaters</li>
                                <li class="disable"> <span class="fa fa-check"></span> Tie, Scarf </li>
                                <li class="disable"> <span class="fa fa-check"></span> Coat, Jacket, Dress</li>
                            </ul>
                            <div class="read-more mt-4 pt-lg-2 text-center">
                ...
                <div class="col-lg-4 col-md-6 price-main-info mt-lg-0 mt-4">
                    <div class="price-inner card">
                        <div class="card-body">
                            <h4 class="text-center mb-3">Premium wash</h4>
                            <h5 class="card-title pricing-card-title">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                ...
                                <li> <span class="fa fa-check"></span> Pants, Jeans, Skirts </li>
                                <li> <span class="fa fa-check"></span> Sweaters</li>
                                <li> <span class="fa fa-check"></span> Tie, Scarf </li>
                                <li> <span class="fa fa-check"></span> Coat, Jacket, Dress</li>
                            </ul>
                            <div class="read-more mt-4 pt-lg-2 text-center">
                                <a href="contact.html" class="btn btn-style"> Order Now</a>
                            </div>
    ...
    <section class="w3l-feature-8 py-5">
        <div class="container py-md-5 py-4">
            ...
            <div class="row features text-center justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
                    <div class="feature-body p-xl-4">
                        ...
                        <div class="feature-info mt-4">
                            <h3 class="feature-title">
                                <a href="about.php">Laundry & Dry Clean</a>
                            </h3>
                            <p class="feature-text">Lorem ipsum dolor sit amet consectetur adipisicing elit sed do
                                eiusmod te incididunt</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
                    <div class="feature-body p-xl-4">
                        ...
                        <div class="feature-info mt-4">
                            <h3 class="feature-title">
                                <a href="about.php">Fold Clothes & Deliver</a>
                            </h3>
                            <p class="feature-text">Lorem ipsum dolor sit amet consectetur adipisicing elit sed do
                                eiusmod te incididunt</p>
                        </div>
            ...
            <div class="text-center">
                <a href="contact.php" class="btn btn-style mt-5">Book Our Services Now</a>
            </div>
        </div>
    </section>
    <!-- //works section -->
                ...
                <div class="row footer-top-29 pt-lg-5 pt-sm-4">
                    ...
                    <div class="col-lg-3 col-sm-6 mt-sm-0 mt-4">
                        <div class="address-grid">
                            ...
                            <h5 class="phone-number-text mt-2"><a href="tel:+1(21) 112 7368">+1(21) 112 7368</a>
                            </h5>
                        </div>
