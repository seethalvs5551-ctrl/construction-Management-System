            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="user_add_estimate.php">Estimate</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="user_vw_labours.php">Labours</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="user_vw_requests.php">Requests</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="user_vw_history.php">History</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="user_vw_products.php">Products</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="user_vw_orders.php">Orders</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="user_vw_feed.php">Feedback</a>
                        </li>
                        <li class="nav-item">
