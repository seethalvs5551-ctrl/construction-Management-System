...
if(isset($_POST['SUBMIT']))
{
    ...
    $amount = $_GET['amount'];
    $today = date("Y-m-d");
    $qry="INSERT INTO `payment` (`amount`,`date`,`br_id`) VALUE ('$amount','$today','$rid')";
    $res = mysqli_query($con,$qry);
    $status_upd="UPDATE `book_request` SET `status` = 'Paid' WHERE `br_id` = $rid";
    ...
    echo "<script>location.href = 'user_vw_requests.php'</script>";
}
?>