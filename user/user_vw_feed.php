        ...
        <div class="contact-top py-lg-5 py-md-4 py-2">
            <div class="container">
                ...
                <h5 class="sub-title">Add your</h5>
                    <h3 class="title-style">Feedback</h3>
                        ...
                        <div class="row top-inputs">
                            <div class="col-md-12">
                                <!-- <label for="to">To date :</label> -->
                                 <textarea name="description" placeholder="Your valuable feedbacks" id="" required></textarea>
                            </div>
                        </div> 
                                <div class="text-end ">
                                    <button type="submit" name="SUBMIT" class="btn btn-style w-100">Send</button>
                                </div>
                            </div>
                        </div>
                        </form>
...
if(isset($_POST['SUBMIT']))
{
    ...
    $qry="INSERT INTO `feedback` (`date`,`u_id`,`feedback`) VALUE ('$today','$uid','$description')";
