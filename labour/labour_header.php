            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="labour_home.php">Home</a>
                        <li class="nav-item">
                            <a class="nav-link" href="labour_vw_requests.php">Requests</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="labour_vw_history.php">History</a>
                        </li>
                        <li class="nav-item">
