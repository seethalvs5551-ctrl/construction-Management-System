                        ...
                        ?>
                                <tr>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                                <td>
                                                    <a href="labour_action.php?rid=<?php echo $row['br_id'] ?>&action=approve_req&targ=labour_vw_History.php"><button class="btn btn-success">Approve</button></a>
                                                    <a href="labour_action.php?rid=<?php echo $row['br_id'] ?>&action=reject_req&targ=labour_vw_History.php"><button class="btn btn-danger">Reject</button></a>
                                                </td>
                                        <?php
                                            }
                                        ...
                                        ?>
                                            <td>
                                                <form action="labour_action.php?action=mark_completed&rid=<?php echo $row['br_id'] ?>&targ=labour_vw_History.php" method="post" class="main-input">
