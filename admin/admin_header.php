            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="adm_vw_usrs.php">Users</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="adm_vw_labours.php">Labours</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="adm_add_delivryb.php">Delivery-boy</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="adm_vw_estimates.php">Estimates</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="adm_add_products.php">Products</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="adm_vw_orders.php">Orders</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="adm_vw_feedbacks.php">Feedbacks</a>
                        </li>
                        </li>
                        <li class="nav-item">
