...
$qry = "SELECT * FROM `prod_book_rq` ORDER BY (`pbr_id`) DESC";
                                ...
                                <tr>
                                    ...
                                    <!-- <td>
                                        <?php
                                            ...
                                            {
                                        ?>
                                                <a href="adm_actions.php?action=deliverd&brid=<?php echo $row['pbr_id'] ?>&amount=<?php echo $row['amount'] ?>"><button class="btn btn-success">Delivered</button></a>
                                        <?php
                                            }
                                        ?>
                                    </td> -->
